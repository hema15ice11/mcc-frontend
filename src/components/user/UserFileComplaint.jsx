        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {message.text && (
              <div className={`mb-6 p-4 rounded-2xl border ${
                  ...
                  statusGradients[message.type]?.light || "bg-gray-50"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select
                        ...
                        onChange={handleChange}
                        className="w-full pl-4 pr-10 py-4 bg-slate-50/70 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 appearance-none font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                      ...
                      placeholder="Please provide detailed information about the issue. Include location specifics, severity, and any other relevant details that will help us address it quickly."
                  ></textarea>
                  </div>
